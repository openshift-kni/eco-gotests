	...
	Label(tsparams.LabelEndToEndUpgrade), func() {
		...
		BeforeAll(func() {
			...
			if findInstalledCSV("kernel-module-management") {
				glog.V(90).Infof("KMM was installed")

				By("Create namespace definition for KMM module")
				kmmNamespace := namespace.NewBuilder(APIClient, kmmModuleNamespaceName)
				kmmNamespace.Definition.Annotations = make(map[string]string)
				kmmNamespace.Definition.Annotations["lca.openshift.io/apply-wave"] = "4"
				...
				kmmServiceAccount.Definition.Annotations = make(map[string]string)
				kmmServiceAccount.Definition.Annotations["lca.openshift.io/apply-wave"] = "5"
				...
				kmmClusterRoleBinding.Definition.Annotations = make(map[string]string)
				kmmClusterRoleBinding.Definition.Annotations["lca.openshift.io/apply-wave"] = "6"
