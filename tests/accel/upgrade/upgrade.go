...
var (
	...
	desiredUpgradeChannel  = accelparams.UpgradeChannel
	stream                 = accelparams.Z
)

var _ = Describe("OCP_UPGRADE", Ordered, Label(accelparams.TeamLabel), func() {
	Context("OCP", Label(accelparams.TeamLabel), func() {
