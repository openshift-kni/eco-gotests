...
var _ = Describe(
	...
	Label(spkparams.LabelSPKIngress), func() {
		...
		It("Asserts workload reachable via IPv4 address", polarion.ID("64119"), Label("spkingresstcp"), func() {
		...
		It("Asserts workload reachable via IPv6 address", polarion.ID("65886"), Label("spkingresstcp"), func() {
