...
var _ = Describe(
	...
	Label("spk-all-suite"), func() {
		Describe("On clean deployment", Label("spk-vanila-deployment"), func() {
			...
			It("Asserts workload reachable via IPv4 UDP", reportxml.ID("72777"), FlakeAttempts(5),
				Label("spkingress-udp", "spkingress-udp-ipv4"),
				spkcommon.VerifySPKIngressUDPviaIPv4)

			It("Asserts workload reachable via IPv6 UDP", reportxml.ID("72778"), FlakeAttempts(5),
