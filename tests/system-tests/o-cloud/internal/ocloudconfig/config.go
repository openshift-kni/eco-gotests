...
type OCloudConfig struct {
	*systemtestsconfig.SystemTestsConfig
	...
	Registry5000 string `yaml:"registry_5000" envconfig:"ECO_REGISTRY_5000"`
	// Registry5005 url for registry in port 5005
	Registry5005 string `yaml:"registry_5005" envconfig:"ECO_REGISTRY_5005"`
	// SSHKey ssh key
	...
	TemplateName string `yaml:"template_name" envconfig:"ECO_TEMPLATE_NAME"`
	//nolint:lll
	...
	TemplateVersionAISuccess string `yaml:"template_version_ai_success" envconfig:"ECO_TEMPLATE_VERSION_AI_SUCCESS"`
	//nolint:lll
	...
	TemplateVersionAIFailure string `yaml:"template_version_ai_failure" envconfig:"ECO_TEMPLATE_VERSION_AI_FAILURE"`
	//nolint:lll
	...
	TemplateVersionDifferentTemplates string `yaml:"template_version_different_templates" envconfig:"ECO_TEMPLATE_VERSION_DIFFERENT_TEMPLATES"`
	//nolint:lll
	...
	TemplateVersionIBISuccess string `yaml:"template_version_ibi_success" envconfig:"ECO_TEMPLATE_VERSION_IBI_SUCCESS"`
	//nolint:lll
	...
	TemplateVersionIBIFailure string `yaml:"template_version_ibi_failure" envconfig:"ECO_TEMPLATE_VERSION_IBI_FAILURE"`
	// TemplateVersionDay2 defines the version of the referenced ClusterTemplate used for the Day 2 operations.
	TemplateVersionDay2 string `yaml:"template_version_day2" envconfig:"ECO_TEMPLATE_VERSION_DAY2"`
	//nolint:lll
	...
	TemplateVersionSeed string `yaml:"template_version_seed" envconfig:"ECO_TEMPLATE_VERSION_SEED"`

	// NodeClusterName1 is the name of the first ORAN Node Cluster.
	NodeClusterName1 string `yaml:"node_cluster_name_1" envconfig:"ECO_NODE_CLUSTER_NAME_1"`
	// NodeClusterName2 is the name of the second ORAN Node Cluster.
	NodeClusterName2 string `yaml:"node_cluster_name_2" envconfig:"ECO_NODE_CLUSTER_NAME_2"`
	// OCloudSiteID is the ID of the of the ORAN O-Cloud Site.
	OCloudSiteID string `yaml:"ocloud_site_id" envconfig:"ECO_OCLOUD_SITE_ID"`
	// ClusterName1 name of the first cluster.
	ClusterName1 string `yaml:"cluster_name_1" envconfig:"ECO_CLUSTER_NAME_1"`
	// ClusterName2 name of the second cluster.
	ClusterName2 string `yaml:"cluster_name_2" envconfig:"ECO_CLUSTER_NAME_2"`

	// SSHCluster2 is the address to ssh the second cluster.
	SSHCluster2 string `yaml:"ssh_address_cluster_2" envconfig:"ECO_SSH_CLUSTER_2"`
	// HostName1 is the hostname of the second cluster.
	HostName1 string `yaml:"hostname1" envconfig:"ECO_HOSTNAME_1"`
	// HostName2 is the hostname of the second cluster.
	HostName2 string `yaml:"hostname2" envconfig:"ECO_HOSTNAME_2"`

	// PTPVersionMajorOld old major version of the PTP operator.
	PTPVersionMajorOld uint64 `yaml:"ptp_version_major_old" envconfig:"ECO_PTP_VERSION_MAJOR_OLD"`
	// PTPVersionMinorOld old minor version of the PTP operator.
	PTPVersionMinorOld uint64 `yaml:"ptp_version_minor_old" envconfig:"ECO_PTP_VERSION_MINOR_OLD"`
	// PTPVersionPatchOld old patch version of the PTP operator.
	PTPVersionPatchOld uint64 `yaml:"ptp_version_patch_old" envconfig:"ECO_PTP_VERSION_PATCH_OLD"`
	// PTPVersionPrereleaseOld old prerelease version of the PTP operator.
	PTPVersionPrereleaseOld uint64 `yaml:"ptp_version_prerelease_old" envconfig:"ECO_PTP_VERSION_PRERELEASE_OLD"`

	// PTPVersionMajorNew new major version of the PTP operator.
	PTPVersionMajorNew uint64 `yaml:"ptp_version_major_new" envconfig:"ECO_PTP_VERSION_MAJOR_NEW"`
	// PTPVersionMinorNew new minor version of the PTP operator.
	PTPVersionMinorNew uint64 `yaml:"ptp_version_minor_new" envconfig:"ECO_PTP_VERSION_MINOR_NEW"`
	// PTPVersionPatchNew new patch version of the PTP operator.
	PTPVersionPatchNew uint64 `yaml:"ptp_version_patch_new" envconfig:"ECO_PTP_VERSION_PATCH_NEW"`
	// PTPVersionPrereleaseNew new prerelease version of the PTP operator.
	PTPVersionPrereleaseNew uint64 `yaml:"ptp_version_prerelease_new" envconfig:"ECO_PTP_VERSION_PRERELEASE_NEW"`
}
