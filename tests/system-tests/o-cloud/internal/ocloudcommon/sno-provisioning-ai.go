...
func VerifySuccessfulSnoProvisioning(ctx SpecContext) {
	...
	allocatedNode, nodeAllocationRequest, namespace, clusterInstance := VerifyAndRetrieveAssociatedCRsForAI(
	...
	DeprovisionAiSnoCluster(provisioningRequest, namespace, clusterInstance, allocatedNode, nodeAllocationRequest, ctx, nil)
}
