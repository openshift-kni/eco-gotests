...
// CreateEgressIPDifferentNodesAndNamespaces create egressIP test setup to verify connectivity on the
// different namespaces and nodes.
func CreateEgressIPDifferentNodesAndNamespaces() {
	By("Creating the packet sniffer deployment with number of pods equals number of EgressIP nodes")
...
func VerifyEgressIPDifferentNodesAndNamespaces() {
	...
	CreateEgressIPDifferentNodesAndNamespaces()
