...
func TestLB(t *testing.T) {
	...
	RunSpecs(t, "SR-IOV", Label(tsparams.Labels...), reporterConfig)
}
...
var _ = BeforeSuite(func() {
	...
	if err != nil {
		Skip(
			fmt.Sprintf("given cluster is not suitable for SR-IOV tests due to the following error %s", err.Error()))
	}
