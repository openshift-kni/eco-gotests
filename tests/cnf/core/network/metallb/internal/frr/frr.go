...
type (
	...
	// Route creates struct of routes from json output.
	Route struct {
	...
	// BgpNeighborGRStatus is a map of neighbor IP addresses to GRStatus structs.
...
// GetGracefulRestartStatus fetches and returns the GracefulRestart starus value for the specified BGP peer.
