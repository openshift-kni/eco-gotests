...
require (
	...
	github.com/openshift-kni/eco-goinfra v0.0.0-20230803163149-ab491f330105
...
replace (
	...
	github.com/openshift/assisted-service/api => github.com/openshift/assisted-service/api v0.0.0-20230125183155-2b97070428e1
